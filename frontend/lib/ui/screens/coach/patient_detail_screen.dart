...
class PatientDetailScreen extends StatelessWidget {
  ...
  static const _currentPlan = [
    ('Przysiady', '3 serie × 12 powt.', 'przerwa 60s'),
    ('Prasa nóg', '3 serie × 15 powt.', 'przerwa 90s'),
    ('Zginanie podudzia', '4 serie × 10 powt.', 'przerwa 60s'),
    ('Wspięcia na palce', '3 serie × 20 powt.', 'przerwa 45s'),
    ('Deska balansowa', '2 serie × 60 sek.', 'przerwa 30s'),
  ];
  ...
  String get _statusLabel => switch (patient.status) {
        ...
        PatientStatus.missedSessions => 'Nieobecności',
        PatientStatus.reportedPain => 'Ból zgłoszony',
      };
  ...
  List<({String label, String value, IconData icon, Color color})>
      get _telemetry => [
            (
              label: 'Śr. głębokość przysiadu',
              value: '87°',
              icon: Icons.straighten_rounded,
              color: const Color(0xFF7C5CFF),
            ),
            (
              label: 'Regularność powt.',
              value: '92%',
