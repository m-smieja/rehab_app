...
class PatientListScreen extends StatelessWidget {
  ...
  static const _mockPatients = [
    PatientData(
      id: '1',
      name: 'Marek Kowalski',
      injuryType: 'Po operacji ACL',
      status: PatientStatus.active,
      nextSession: 'Dziś, 15:00',
      completionRate: 87,
    ),
    PatientData(
      id: '2',
      name: 'Anna Nowak',
      injuryType: 'Naprawa stożka rotatorów',
    ...
    PatientData(
      ...
      injuryType: 'Rehabilitacja kręgosłupa',
      status: PatientStatus.missedSessions,
      nextSession: 'Pt, 14:00',
      completionRate: 45,
    ),
    PatientData(
      id: '4',
    ...
    PatientData(
      ...
      injuryType: 'Po endoprotezie biodra',
      status: PatientStatus.active,
      nextSession: 'Czw, 11:00',
      completionRate: 78,
    ),
  ];
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${_mockPatients.length} aktywnych przypadków',
...
class _PatientCard extends StatelessWidget {
  ...
  String get _statusLabel => switch (patient.status) {
        ...
        PatientStatus.missedSessions => 'Nieobecny',
        PatientStatus.reportedPain => 'Ból',
      };
